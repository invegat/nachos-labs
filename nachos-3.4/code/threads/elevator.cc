...
ELEVATOR::ELEVATOR(int lNumFloors) {
	...
	personsOn = new Person*[100]; // limited to 100 student/teachers
...
void ELEVATOR::hailElevator(Person *p) {
	...
	removeFromPP((Person **)personsOn, p);
